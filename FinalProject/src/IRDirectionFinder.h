...
public:
  ...
  //Boolean for if the IR camera has sensed a signal from the emitter
  bool CameraSensedSignal();

  //Makes the emitter go from HIGH to LOW every 250ms
  void TransmitterToggle();
